...
using IczpNet.Chat.Management.Connections;
...
{
    public class ConnectionManagementAppService
        : CrudAppService<
            Connection,
            ConnectionDto,
            Guid,
        ...
        IConnectionManagementAppService
    {
        ...
        public ConnectionManagementAppService(
