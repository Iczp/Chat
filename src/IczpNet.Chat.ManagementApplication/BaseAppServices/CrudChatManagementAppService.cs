...
public abstract class CrudChatManagementAppService<
    TEntity,
    TGetOutputDto,
    TGetListOutputDto,
    TKey,
    ...
    //where TUpdateInput : IName
{
    ...
    protected CrudChatManagementAppService(IRepository<TEntity, TKey> repository) : base(repository)
    {
