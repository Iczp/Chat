...
using IczpNet.Chat.Management.Management.SessionSections.SessionPermissionDefinitions;
using IczpNet.Chat.Management.Permissions;

namespace IczpNet.Chat.Management.SessionServices
{
    public class SessionPermissionDefinitionManagementAppService
        ...
        ISessionPermissionDefinitionManagementAppService
    {

        protected override string UpdatePolicyName { get; set; } = ChatManagementPermissions.SessionPermissionDefinitionPermission.Update;
        protected virtual string SetIsEnabledPolicyName { get; set; } = ChatManagementPermissions.SessionPermissionDefinitionPermission.SetIsEnabled;
        ...
        public SessionPermissionDefinitionManagementAppService(
