...
using IczpNet.Chat.Management.SessionSections.Sessions;
...
namespace IczpNet.Chat.Management.Management.SessionServices
{
    public class SessionManagementAppService : ChatManagementAppService, ISessionManagementAppService
    {
        ...
        public SessionManagementAppService(
        ...
        [HttpPost]
        public async Task<OpenedRecorderManagementDto> SetOpenedAsync(OpenedRecorderManagementInput input)
        {
            var entity = await SessionManager.SetOpenedAsync(input.OwnerId, input.DestinationId, input.MessageId, input.DeviceId);

            return ObjectMapper.Map<OpenedRecorder, OpenedRecorderManagementDto>(entity);
        }
