...
using IczpNet.Chat.Management.SessionSections.SessionUnits;
...
public class SessionUnitManagementAppService : ChatManagementAppService, ISessionUnitManagementAppService
{
    ...
    public SessionUnitManagementAppService(
