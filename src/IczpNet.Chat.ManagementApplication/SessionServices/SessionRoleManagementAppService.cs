...
using IczpNet.Chat.Management.SessionSections.SessionRoles;

namespace IczpNet.Chat.Management.SessionServices
{
    public class SessionRoleManagementAppService
        ...
        ISessionRoleManagementAppService
    {
        ...
        public SessionRoleManagementAppService(
