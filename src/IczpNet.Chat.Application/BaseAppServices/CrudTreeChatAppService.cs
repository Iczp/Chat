    ...
    where TTreeInfo : ITreeInfo<TKey>
{
    ...
    /// <returns></returns>
    [HttpPost]
    public override Task<string> RepairDataAsync(int maxResultCount = 100, int skinCount = 0, string sorting = null)
    {
        return base.RepairDataAsync(maxResultCount, skinCount, sorting);
    }
    #endregion
}
