...
namespace IczpNet.Chat.Migrations
{
    ...
    [Migration("20230525035644_SessionUnitCounter_AddProp_LastMessageId")]
    partial class SessionUnitCounter_AddProp_LastMessageId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IczpNet.Chat.MessageSections.Recorders.FavoritedValue", b =>
                {
                    b.Property<long>("MessageId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Chat_FavoritedValue", (string)null);
                });

            modelBuilder.Entity("IczpNet.Chat.MessageSections.Recorders.OpenedValue", b =>
                {
                    b.Property<long>("MessageId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Chat_OpenedValue", (string)null);
                });

            modelBuilder.Entity("IczpNet.Chat.MessageSections.Recorders.ReadedValue", b =>
                {
                    b.Property<long>("MessageId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Chat_ReadedValue", (string)null);
                });
            ...
            modelBuilder.Entity("IczpNet.Chat.MessageSections.Recorders.FavoritedValue", b =>
                {
                    b.HasOne("IczpNet.Chat.MessageSections.Messages.Message", "Message")
                        .WithOne("FavoritedValue")
                        .HasForeignKey("IczpNet.Chat.MessageSections.Recorders.FavoritedValue", "MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IczpNet.Chat.MessageSections.Recorders.OpenedValue", b =>
                {
                    b.HasOne("IczpNet.Chat.MessageSections.Messages.Message", "Message")
                        .WithOne("OpenedValue")
                        .HasForeignKey("IczpNet.Chat.MessageSections.Recorders.OpenedValue", "MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IczpNet.Chat.MessageSections.Recorders.ReadedValue", b =>
                {
                    b.HasOne("IczpNet.Chat.MessageSections.Messages.Message", "Message")
                        .WithOne("ReadedValue")
                        .HasForeignKey("IczpNet.Chat.MessageSections.Recorders.ReadedValue", "MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("IczpNet.Chat.SessionSections.SessionUnits.SessionUnit", b =>
                {
                    ...
                    b.Navigation("SessionUnitCounter");
