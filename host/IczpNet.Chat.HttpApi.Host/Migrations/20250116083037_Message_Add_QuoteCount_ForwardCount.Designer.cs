...
namespace IczpNet.Chat.Migrations
{
    ...
    [Migration("20250116083037_Message_Add_QuoteCount_ForwardCount")]
    partial class Message_Add_QuoteCount_ForwardCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IczpNet.Chat.SessionUnits.SessionUnit", b =>
                {
                    ...
                    b.HasIndex(new[] { "Sorting", "LastMessageId", "IsDeleted" }, "IX_Chat_SessionUnit_Sorting_Desc_LastMessageId_Asc")
                        .IsDescending(true, false, true);

                    b.ToTable("Chat_SessionUnit", (string)null);
                });

            modelBuilder.Entity("IczpNet.Chat.SessionUnits.SessionUnitSetting", b =>
                {
                    b.Property<Guid>("SessionUnitId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IczpNet.Chat.SessionUnits.SessionUnitSetting", b =>
                {
                    ...
                    b.HasOne("IczpNet.Chat.SessionUnits.SessionUnit", "SessionUnit")
                        .WithOne("Setting")
                        .HasForeignKey("IczpNet.Chat.SessionUnits.SessionUnitSetting", "SessionUnitId");
