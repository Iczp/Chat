        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsStatic = table.Column<bool>(type: "bit", nullable: false, comment: "是否固定成员"),
                    IsPublic = table.Column<bool>(type: "bit", nullable: false, comment: "是否公有成员"),
                    IsInputEnabled = table.Column<bool>(type: "bit", nullable: false, comment: "是否启用输入框"),
                    IsEnabled = table.Column<bool>(type: "bit", nullable: false, comment: "是否可用"),
                    IsCreator = table.Column<bool>(type: "bit", nullable: false, comment: "是否创建者（群主等）"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Chat_SessionUnitSetting_Chat_SessionUnit_InviterId",
                        column: x => x.InviterId,
                        principalTable: "Chat_SessionUnit",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Chat_SessionUnitSetting_Chat_SessionUnit_KillerId",
                        column: x => x.KillerId,
                        principalTable: "Chat_SessionUnit",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chat_SessionUnitSetting_InviterId",
